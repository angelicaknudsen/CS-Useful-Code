...
sleep(0.05) #brb gonna look up why we need this
#so actually I'm not going to bother messing with this
...
'''Jelly's input: lmao yeahhhh
So a socket in a network is basically an endpoint in two-way communication that can send
