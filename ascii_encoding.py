...
#oof I should add here that in the range parameters for the for loop, the first number is inclusive
#while the second number is exclusive
#so this loop would actually go from 49 to 127, like specified in the challenge
for x in range(49, 128): #love u python forever
  print(chr(x))